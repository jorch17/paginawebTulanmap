...
class Insert:
    ...
    def POST(self):
        ...
        # call model insert_rutingo and try to insert new data
        config.model.insert_rutingo(
            form['nombre'],form['costo'],form['hora_inicio'],form['hora_final'],form['tiempo_recorrido'],
        )
